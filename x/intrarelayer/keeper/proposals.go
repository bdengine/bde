...
import (
	...
	"github.com/tharsis/bdeos/x/intrarelayer/types"
	"github.com/tharsis/bdeos/x/intrarelayer/types/contracts"
)
...
// CreateCoinMetadata generates the metadata to represent the ERC20 token on bde.
