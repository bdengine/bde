...
import (
	...
	bdeosnetwork "github.com/tharsis/bdeos/testutil/network"
...
Example:
	bdeosd testnet init-files --v 4 --output-dir ./.testnets --starting-ip-address 192.168.10.2
	`,
	...
	cmd.Flags().String(flagNodeDaemonHome, "bdeosd", "Home directory of the node's daemon configuration")
...
Example:
	bdeosd testnet --v 4 --output-dir ./.testnets
	`,
		RunE: func(cmd *cobra.Command, _ []string) error {
			args := startArgs{}
			args.outputDir, _ = cmd.Flags().GetString(flagOutputDir)
...
func initTestnetFiles(
	...
	if args.chainID == "" {
		args.chainID = fmt.Sprintf("bdeos_%d-1", tmrand.Int63n(9999999999999)+1)
	}
...
func startTestnet(cmd *cobra.Command, args startArgs) error {
	networkConfig := bdeosnetwork.DefaultConfig()
